    ...
    export const metadata = {
      title: "Self-Reflection Guides",
      description: "Frameworks you can use daily for clarity and self-trust.",
    }
      ...
      return (
        <main className="bg-[#070707] text-white min-h-screen">
          <section className="max-w-5xl mx-auto px-6 py-16 space-y-6">
            <h1 className="text-4xl font-bold">Self-Reflection Guides</h1>
            <p className="text-white/70 text-lg">Frameworks you can use daily for clarity and self-trust.</p>
...
<li>• <Link className='underline' href='/h/answers'>Answers hub</Link></li>
