    ...
    export const metadata = {
      ...
      description: "Simple models for hard choices: values, tradeoffs, and next steps.",
    }
      ...
      return (
        <main className="bg-[#070707] text-white min-h-screen">
          <section className="max-w-5xl mx-auto px-6 py-16 space-y-6">
            <h1 className="text-4xl font-bold">Decision-Making Tools</h1>
            <p className="text-white/70 text-lg">Simple models for hard choices: values, tradeoffs, and next steps.</p>
